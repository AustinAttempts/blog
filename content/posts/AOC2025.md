...
This was my second year diving into [Advent of Code (AOC)](https://adventofcode.com/), the annual programming puzzle extravaganza. For the first time, I managed to complete all puzzles within the event. The shorter 12-day format this year (down from the usual 25) probably helped!  
